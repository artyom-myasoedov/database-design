...
<@header.page>
    <div class="row">
        <div class="col-2">
            ...
            <form method="get" action="/pupil/byFirstNameAndLastName">
            ...
            <form method="get" action="/pupil/findAndSort">
            ...
            <table class="table">
                ...
                <#list pupils as pupil>
                    <tr>
                        ...
                        <td>${pupil.getUsername()}</td>
                        <td>${pupil.getClassDto()}</td>
                        <td>
                            <div class="container-fluid">
                                <form action="/pupil/deleteById" method="get" class="m-2">
                                    <button class="btn btn-danger" type="submit" name="id" value="${pupil.getId()}">
                                        Удалить
                                    </button>
                                </form>
                                <form action="/pupil/getTimetable" method="get" class="m-2">
                                    <button class="btn btn-primary" type="submit" name="id" value="${pupil.getId()}">
                ...
                <#else>
                    <p class="m-3">Отсутствуют записи об учениках</p>
                </#list>
                </tbody>
            </table>
        </div>
